...
module.exports = __webpack_require__(/*! C:\Users\Callum\Workspace\Prototypes\phaser-es6\src\main.js */330);
...
var _webfontloader = __webpack_require__(/*! webfontloader */ 336);
    ...
    value: function preload() {
      ...
      _webfontloader2.default.load({
        ...
        active: function active() {
          return _this2.fontsReady = true;
        }
      });

      var text = this.add.text(this.world.centerX, this.world.centerY, 'Boot Screen', {
        font: '16px Arial', fill: '#efefef', align: 'center'
      });
